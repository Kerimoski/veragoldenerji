...
export default function OperasyonlarPage() {
  ...
  const videos = [
    ...
    },
    {
      ...
      title: isTr ? "Endüstriyel Su Sondaj Kulesi Çalışması" : "Industrial Water Well Boring Rig",
      desc: isTr ? "Saha ortamında yüksek basınçlı hava destekli çamur sirkülasyonlu su sondajı." : "High-pressure air assisted mud circulation water well drilling in action.",
      tag: "FIELD VIDEO // WATER WELL",
    },
    {
      id: "vid-4",
      src: "/gorseller/sondaj-makineleri/WhatsApp_Video_2026-08-11_at_14.48.56.mp4",
      title: isTr ? "Kaya Sondaj Kulesi Tij Ekleme & Borulama" : "Drill Rod Handling & Casing Operation",
      desc: isTr ? "Otomatik tij ve muhafaza borusu yerleştirme sistemi canlı saha kaydı." : "Automatic drill rod and casing handling system recorded live on site.",
      tag: "FIELD VIDEO // ROD HANDLING",
    },
    {
      id: "vid-5",
      src: "/gorseller/sondaj-makineleri/WhatsApp_Video_2026-08-11_at_14.48.57.mp4",
      title: isTr ? "Paletli Derin Kuyu Sondaj Kulesi Canlı Çekim" : "Tracked Deep Well Rig Live Action",
      desc: isTr ? "Paletli mobil kule ile derin katman karot ve su arama delgisi." : "Tracked mobile rig drilling deep layer core and groundwater exploration.",
      tag: "FIELD VIDEO // CRAWLER RIG",
    },
    {
      id: "vid-6",
      src: "/gorseller/sondaj-makineleri/WhatsApp_Video_2026-08-11_at_14.48.57_1.mp4",
      title: isTr ? "24 Bar DTH Delgi & Çamur Sirkülasyonu" : "24 Bar DTH Drill & Mud Circulation",
      desc: isTr ? "Kompresör havası ve çamur pompası senkronize delgi operasyonu." : "Synchronized compressor air and mud pump drilling operation.",
      tag: "FIELD VIDEO // 24 BAR DTH",
    },
    {
      id: "vid-7",
      src: "/gorseller/reklam-gorselleri/WhatsApp_Video_2026-08-11_at_14.49.10.mp4",
      title: isTr ? "Vera Gold Enerji Filo Tanıtım Kaydı" : "Vera Gold Fleet Presentation Video",
      desc: isTr ? "Avrupa ve Balkanlar projesi şantiye teslimi ve saha hazırlığı." : "Balkans & European project site setup and fleet deployment.",
      tag: "FIELD VIDEO // FLEET SHOWCASE",
    },
    {
      id: "vid-8",
      src: "/makineler/WhatsApp Video 2026-07-13 at 16.02.17.mp4",
      title: isTr ? "Mobil Servis & Saha Destek Çekimi" : "Mobile Field Service & Technical Support",
